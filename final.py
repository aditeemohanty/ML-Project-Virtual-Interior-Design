...
# Page configuration
st.set_page_config(
    page_title="Furniture Room Designer",
    page_icon="🪑",
    layout="wide"
)
...
# Header
st.markdown('<div class="header">Furniture Room Designer</div>', unsafe_allow_html=True)
st.markdown(
    '<div class="info-text">Complete room design solution: Upload a room image to detect and reposition existing furniture or generate a completely new furnished room design.</div>',
    unsafe_allow_html=True)
...
tab1, tab2, tab3, tab4 = st.tabs(["Upload & Detect", "Reposition", "Compare", "Generate New Design"])

# Tab 1: Upload and Detect Furniture
with tab1:
...
with st.sidebar:
    ...
    1. **Furniture Repositioning System**: Detect and move existing furniture in your room photos
    
    2. **AI Room Designer**: Generate completely new room designs with different furnishing styles
